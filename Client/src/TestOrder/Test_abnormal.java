...
public class Test_abnormal {
	...
	Date time3=null;
    MockOrder a=new MockOrder("000001","012","000", 2, 100, 3, false, "double", 303, time1, time2, time3,time3,time4, "good", 100);
	...
	public void test() {
		...
		Choice c=null;
		order.abnormalOrder("000", "012");
		assertEquals(1,use.getUser().getLevel());
		assertEquals(1,cr.getUser().getCurrentcredit());
	}
}
