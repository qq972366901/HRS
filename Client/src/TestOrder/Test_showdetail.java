...
public class Test_showdetail {
	...
	public void test() {
		...
		assertNotEquals(b.getOrderNumber(),order.showDetail("000").getorder().getOrderNumber());
		assertEquals(a.getOrderNumber(),order.showDetail("000").getorder().getOrderNumber());
		assertEquals(b.getChild(),order.showDetail("023").getorder().getChild());
	}
