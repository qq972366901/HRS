...
public class Test_show {
	...
	public void test() {
		...
		assertEquals(b.getOrderNumber(),order.show().get(1).getorder().getOrderNumber());
		assertEquals(a.getOrderNumber(),order.show().get(0).getorder().getOrderNumber());
		assertEquals(b.getChild(),order.show().get(1).getorder().getChild());
		assertEquals(b.getNumOfPerson(),order.show().get(1).getorder().getNumOfPerson());
		assertEquals(a.getChild(),order.show().get(0).getorder().getChild());
		assertEquals(a.getNumOfPerson(),order.show().get(0).getorder().getNumOfPerson());
	}
