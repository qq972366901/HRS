...
public class Test_findByHotel {
	...
	public void test() {
		...
		assertEquals(a.getOrderNumber(),order.findByType(new HotelVO()).get(0).getorder().getOrderNumber());
		assertEquals(b.getOrderNumber(),order.findByType(new HotelVO()).get(1).getorder().getOrderNumber());
	}
