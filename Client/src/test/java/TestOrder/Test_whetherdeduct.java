 ...
 * @see
 */
public class Test_whetherdeduct {
    ...
    MockOrder b=new MockOrder("000001","00101","023", 1, 155, 4, true, "one", 305, time4, time5, time1,time4,time4, "very good", 98);
	...
	public void test() {
		...
		assertEquals(order.whetherDeduct(time4, "023"),true);
		assertEquals(order.whetherDeduct(time4, "025"),false);
	}
