...
public class UserCreditManagement_Driver {
	 public void drive(UserBLService userBLService) throws RemoteException{
		 ResultMessage result1=userBLService.findByID("12");
			...
			ResultMessage result3=userBLService.updateCredit(new UserVO("1","1","3414141","1",false,1,78,"普通会员",UserType.Customer,time1,""),200);
			if(result3 ==ResultMessage.Exist) System.out.println("updateCredit success");
			Calendar time2=Calendar.getInstance();
			time2.set(2016,11,11);
			ResultMessage result4=userBLService.updateLevel(new UserVO("1","1","3414141","1",false,1,78,"普通会员",UserType.Customer,time2,""));
			if(result4 ==ResultMessage.Exist) System.out.println("updateLevel success");
			Calendar time3=Calendar.getInstance();
			time3.set(2016,11,11);
			ResultMessage result5=userBLService.updateCreditRecord(new UserVO("1","1","3414141","1",false,1,78,"普通会员",UserType.Customer,time3,""));
