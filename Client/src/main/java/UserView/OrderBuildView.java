			...
			public void actionPerformed(ActionEvent e) {
			    ...
			    if(nowday!=day){
					...
					int option = JOptionPane.showConfirmDialog(pane,"      你的订单总计"+price2+"元"+"\n             确认提交？","", JOptionPane.YES_NO_OPTION,JOptionPane.WARNING_MESSAGE, null);
					   ...
					   OrderVO ordervo=new OrderVO(controller.getHotelID(),controller.getUserID(),orderid,2,price2,(int)comboBox12.getSelectedItem(),children,(String)comboBox10.getSelectedItem(),selected,calin,calout,calin,null,cal,null,0);
